            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form class="needs-validation text-start" enctype="multipart/form-data" id="register" method="POST" novalidate="">             
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="first_name" pattern="[a-zA-Z0-9]{2,20}"  name="first_name" placeholder="First Name" required>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="last_name" pattern="[a-zA-Z0-9]{2,20}"  name="last_name" placeholder="Last Name" required>
