          ...
          <div class="row text-center">
            <div class="col-lg-6 col-xl-5 mx-auto text-start">
              ...
              <form class="needs-validation text-start" enctype="multipart/form-data" method="POST" novalidate="">              
                ...
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="first_name" name="first_name" pattern="[a-zA-Z0-9]{2,20}" required placeholder="First Name" value="<?=$query[0]["first_name"]?>" />
                  <label for="first_name">First Name</label>
                </div>
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="last_name" name="last_name" pattern="[a-zA-Z0-9]{2,20}" required placeholder="Last Name" value="<?=$query[0]["last_name"]?>" />
